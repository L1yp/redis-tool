...
public class RedisKey {
    ...
    RedisKey(String prefix, Duration expireTime, long expireAt){
        this.prefix = prefix;
        this.expireTime = expireTime;
     ...
     */
    public RedisKey dup(){
        return new RedisKey(prefix, expireTime, expireAt);
    }
    ...
    public static class Builder {
        ...
        Builder(String prefix, Duration expireTime){
            this(prefix, expireTime, 0);
        }

        Builder(String prefix, Duration expireTime, long expireAt){
            this.prefix = prefix;
            this.expireTime = expireTime;
            this.expireAt = expireAt;
        }
